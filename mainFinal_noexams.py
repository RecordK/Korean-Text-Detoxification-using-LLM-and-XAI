...
from chat_generate_noexams import ChatGenerator 
...
output_file_path = '/home/jupyter/Korean_Text_Detoxification/results/Final_noexams.txt'
converted_sentences = []
...
for sentence in lines:
    ...
    if need_convert:
        ...
        # converted_sentences.append((ori_sentence,'\t',converted_sentence.content))
