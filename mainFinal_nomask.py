...
from chat_generate_no_mask import ChatGenerator 
...
# 댓글 입력
test_data = open('/home/jupyter/Korean_Text_Detoxification/data/ToxicData.txt','r') 
lines = test_data.readlines()
output_file_path = '/home/jupyter/Korean_Text_Detoxification/results/Final_nomask.txt'
converted_sentences = []
# sentence = lines[12] 
# for line in lines:
#     print(line)
...
for sentence in lines:
    ...
    if need_convert:
        ...
        converted_sentence = generator.covert_sentence(ori_sentence)
